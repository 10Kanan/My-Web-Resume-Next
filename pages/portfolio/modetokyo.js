...
const Work = () => (
  <Layout title="mode.tokyo">
    <Container>
      ...
      <WorkImage
        src="/images/portfolio/modetokyo_eyecatch.png"
        alt="mode.tokyo"
      />
      <SimpleGrid columns={2} gap={2}>
        <WorkImage src="/images/portfolio/modetokyo_01.png" alt="mode.tokyo" />
        <WorkImage src="/images/portfolio/modetokyo_02.png" alt="mode.tokyo" />
      </SimpleGrid>
      <WorkImage src="/images/portfolio/modetokyo_03.jpg" alt="mode.tokyo" />
    </Container>
  </Layout>
)
