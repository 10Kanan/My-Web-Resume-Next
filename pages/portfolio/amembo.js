...
const Work = () => (
  <Layout title="amembo">
    <Container>
      ...
      <Center my={6}>
        <Image src="/images/portfolio/amembo_icon.png" alt="icon" />
      </Center>
      <P>
      ...
      <SimpleGrid columns={2} gap={2}>
        <WorkImage src="/images/portfolio/amembo_01.gif" alt="amembo" />
        <WorkImage src="/images/portfolio/amembo_02.gif" alt="amembo" />
      </SimpleGrid>
      <WorkImage src="/images/portfolio/amembo_03.jpg" alt="amembo" />
      <WorkImage src="/images/portfolio/amembo_04.jpg" alt="amembo" />
    </Container>
  </Layout>
)
